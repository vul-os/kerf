...
// ReactingFlowPanel.jsx is not yet migrated, so there's no Props type to
// import; this mirrors the fields it destructures from its own props.
interface ReactingFlowContent {
...
const DEFAULTS: ReactingFlowContent = {
  mechanism: null,
  n_species: null,
  species_names: [],
...
function parseContent(content: string | undefined): ReactingFlowContent {
  if (!content || typeof content !== 'string') return {}
  try { return JSON.parse(content) || {} } catch { return {} }
}

export default function ReactingFlowWrapper({ content }: Props) {
