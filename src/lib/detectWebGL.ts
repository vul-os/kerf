...
export function detectWebGL() {
  try {
    ...
    const ctx: WebGLRenderingContext | WebGL2RenderingContext | null =
      canvas.getContext('webgl2') ||
      canvas.getContext('webgl') ||
      // 'experimental-webgl' isn't a typed overload of getContext; old
      // browsers returned a WebGLRenderingContext under this name.
