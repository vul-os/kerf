...
describe('Landing.jsx — PerDomain section removed', () => {
  const landingSrc = readFileSync(
    (existsSync(resolve(__dirname, '../Landing.tsx')) ? resolve(__dirname, '../Landing.tsx') : (existsSync(resolve(__dirname, '../Landing.tsx')) ? resolve(__dirname, '../Landing.tsx') : (existsSync(resolve(__dirname, '../Landing.tsx')) ? resolve(__dirname, '../Landing.tsx') : resolve(__dirname, '../Landing.jsx')))),
    'utf8',
  )
