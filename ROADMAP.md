...
| **T-100** | **FEM matching CalculiX / Z88 / Mystran depth** — buckling + harmonic + PSD + acoustics + EM + fatigue + **explicit dynamics ✅** (`kerf-fem/explicit_dynamics.py`; central-difference Newmark β=0, HRZ lumped mass, Green-Lagrange + J2 plasticity, CFL dt) shipped; remaining: full nonlinear static, k-ε turbulence, coupled variation. | Serious simulation work. | 🚧 in flight |
