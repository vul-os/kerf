...
const ETEXTILES_JSX = (existsSync(resolve(__dirname, '../ETextilesPanel.tsx')) ? resolve(__dirname, '../ETextilesPanel.tsx') : (existsSync(resolve(__dirname, '../ETextilesPanel.tsx')) ? resolve(__dirname, '../ETextilesPanel.tsx') : resolve(__dirname, '../ETextilesPanel.jsx')))
