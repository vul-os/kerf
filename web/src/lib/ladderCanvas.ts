...
export function createRung(id?: string) {
  return {
    id: id ?? uid('rung'),
    contacts: [],
    coils: [],
 ...
 */
export function addContact(rung, type, position, opts: { name?: string; negated?: boolean } = {}) {
 ...
 * @returns {object} new rung
 */
export function addCoil(rung, type, position, opts: { name?: string } = {}) {
