...
const DrawingPanel = lazy(() => import('./components/drawings/DrawingPanel.jsx'))
...
const BIMCivilPanel = lazy(() => import('./components/arch/BIMCivilPanel.jsx'))
...
export default function App() {
  ...
  return (
    ...
    <Routes>
      ...
      <Route path="/cobie" element={<COBiePage />} />
      <Route path="/configurator" element={<ConfiguratorPage />} />
      <Route path="/sysml-trace" element={<SysMLTracePage />} />
      ...
      <Route path="/drawings" element={<DrawingPanel />} />
      ...
      <Route path="/aec" element={<BIMCivilPanel />} />
      <Route path="/bim" element={<BIMCivilPanel />} />
