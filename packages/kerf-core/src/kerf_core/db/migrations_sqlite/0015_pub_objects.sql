-- AUTO-GENERATED from ../migrations/0015_pub_objects.sql by scripts/gen_sqlite_migrations.py — DO NOT EDIT BY HAND.
...
CREATE TABLE IF NOT EXISTS pub_manifests (
    id          blob       PRIMARY KEY,
    body        blob       NOT NULL,   -- deterministic CBOR of the PubManifest
    created_at  text NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS pub_announces (
    id          blob       PRIMARY KEY,
    body        blob       NOT NULL,   -- deterministic CBOR of the signed PubAnnounce
    created_at  text NOT NULL DEFAULT CURRENT_TIMESTAMP
);
...
CREATE TABLE IF NOT EXISTS pub_feed_entries (
    pub         blob       NOT NULL,   -- author IK (32 B)
    seq         bigint      NOT NULL,
    entry_id    blob       NOT NULL,   -- content address of this FeedEntry (33 B)
    body        blob       NOT NULL,   -- deterministic CBOR of the FeedEntry
    created_at  text NOT NULL DEFAULT CURRENT_TIMESTAMP,
    PRIMARY KEY (pub, seq)
);
...
CREATE TABLE IF NOT EXISTS pub_feed_heads (
    pub           blob       PRIMARY KEY,   -- author IK (32 B)
    body          blob,                     -- deterministic CBOR of the signed FeedHead
...
CREATE TABLE IF NOT EXISTS pub_availability (
    ...
    known_holders  text       NOT NULL DEFAULT '{}',
    updated_at     text NOT NULL DEFAULT CURRENT_TIMESTAMP
);
