-- AUTO-GENERATED from ../migrations/0016_pub_wake_subscriptions.sql by scripts/gen_sqlite_migrations.py — DO NOT EDIT BY HAND.
...
CREATE TABLE IF NOT EXISTS pub_wake_subscriptions (
    pub          blob       NOT NULL,   -- followed author's Ed25519 IK (32 B)
