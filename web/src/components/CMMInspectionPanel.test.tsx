...
import CMMInspectionPanelUntyped, {
  parseCMMFile,
  fmtMm,
  inTolerance,
  detectCMMTool,
...
// CMMInspectionPanel.jsx is not yet migrated (T-515); its destructured props
...
const CMMInspectionPanel = CMMInspectionPanelUntyped as unknown as ComponentType<Record<string, unknown>>
