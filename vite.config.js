...
// The build outputs into `backend/internal/web/dist/` so the Go server can
// embed it via //go:embed. In dev, Vite serves :5173 directly (HMR) and
// proxies /api + /auth to the backend on VITE_API_URL.
