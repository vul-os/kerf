...
| **Sketcher: symmetry over arbitrary construction line** | 🔮 planned | Extends the existing axis-aligned symmetry constraint to mirror a sub-selection across an arbitrary construction line (current symmetry is horizontal/vertical only). Carbon-copy + axis-aligned symmetry both already shipped. |
