...
export function surfaceFinishGlyph(params: { ra?: string | number; text?: string | number; machined?: boolean } = {}) {
...
export function weldGlyph(params: { text?: string; side?: 'arrow' | 'other' } = {}) {
...
export function gdtGlyph(params: { characteristic?: string; symbol?: string; tolerance?: string; value?: string; datums?: string; datum?: string } = {}) {
...
export function balloonGlyph(params: { number?: string | number; text?: string | number; radius?: number } = {}) {
...
export function zigzagPoints(p1: { x: number; y: number }, p2: { x: number; y: number }, opts: { peaks?: number; amplitude?: number } = {}) {
