...
Kerf is **100% MIT** — free, open-source software with no paid tier, no billing, and no hosted product. (The former dual-license split is retired; see the 2026-07-17 final-form ADR in `decisions.md`.)
...
**Licensing constraint (decided 2026-08-05):** the analysis recommended `kiutils` as the parser backbone. It is **GPLv3**, and Kerf is 100% MIT. Decision: **stay MIT-clean** — extend Kerf's own s-expression reader; `kiutils` remains an optional, lazily-guarded extra for library import only, exactly as today. No GPL dependency enters the interop path.
