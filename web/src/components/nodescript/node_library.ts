/**
 * node_library.ts — Node catalog for the Visual Node Scripting system.
 *
 * Each entry defines:
...
import type { NodeDef, PinType } from './nodescriptTypes'

// ---------------------------------------------------------------------------
// Math
// ---------------------------------------------------------------------------

const MATH_NODES: NodeDef[] = [
  {
    id: 'number',
    label: 'Number',
    category: 'Math',
...
export function getNodesByCategory(): Map<NodeDef['category'], NodeDef[]> {
  const groups = new Map<NodeDef['category'], NodeDef[]>()
...
export function pinsCompatible(fromType: PinType, toType: PinType): boolean {
  if (fromType === 'any' || toType === 'any') return true
  return fromType === toType
}

/** Category colour tokens */
export const CATEGORY_COLORS: Record<NodeDef['category'], string> = {
