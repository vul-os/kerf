"""Pytest configuration for kerf-interior tests.

Adds every kerf-* package's src/ directory to sys.path so that imports
resolve without requiring ``pip install -e`` of any package.
"""
import os
import sys
