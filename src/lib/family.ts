 ...
 * @returns {object}
 */
export function resolveParams(family, instance: { type_id?: string; params?: Record<string, unknown> } = {}): Record<string, unknown> {
 ...
 * @returns {{ ok: boolean, errors: string[] }}
 */
export function validateInstance(family, instance: { type_id?: string; params?: Record<string, unknown> } = {}) {
  const errors = []
