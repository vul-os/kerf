...
// Indexed by op name — the fixed built-ins above plus BACKEND_OPS entries
// populated below, so the registry needs a string index signature.
const graphOps: Record<string, (params: unknown, ctx?: unknown) => unknown> = {
  number_slider,
  integer_slider,
  panel,
  series,
