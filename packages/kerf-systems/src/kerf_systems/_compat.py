"""
Compatibility shims for running kerf_systems outside of the kerf-core backend.

When kerf_systems is installed as a plugin (and kerf_chat.tools.registry /
