...
Scope and honest caveats:
  ...
  • Roof slopes ≤ 7° only — steeper slopes require Fig 30.3-2D (gabled/hip
    roofs) which uses different GCp anchors; not implemented here.
  • Minimum pressure per §30.2.2: +/- 16 psf not enforced automatically;
    engineer must check.
  • Parapet C&C pressures (§30.9) not modelled here.
...
class ComponentSpec:
    ...
    zone : str
        Pressure zone per ASCE 7-22 §30.3 / Fig 30.3-2:
          ...
          "Zone_1_roof_interior" — field of roof, flat/low-slope (≤7°)
...
def compute_wind_cc_pressure(
    ...
    code_sections = [
        ...
        "ASCE 7-22 Fig 30.3-2C (GCp vs effective area — roofs ≤7° slope)",
    ]
    ...
    caveat = (
        ...
        f"enclosure={building.enclosure}. "
        ...
        f"parapets (§30.9); roof slopes >7° (Fig 30.3-2D not implemented); "
